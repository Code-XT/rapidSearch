...
const Page = async ({ params }) => {
  ...
  return (
    <div className="py-8 pb-8 px-12 divide-y divide-zinc-100 bg-current opacity-75 shadow-md rounded-md my-8">
      <div>
        <BackButton />
        ...
        <div className="mt-4">
          ...
          <div className="mt-4 space-y-6">
            <p className="text-base max-w-prose text-muted-foreground text-gray-300">
              {product.description}
            </p>
          </div>
